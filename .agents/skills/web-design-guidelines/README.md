...
| Field | Value |
| --- | --- |
| **Name** | `web-design-guidelines-skill` |
...
cp -r web-design-guidelines ~/.hermes/skills/web-design-guidelines/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/web-design-guidelines-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/web-design-guidelines-skill.git ~/.hermes/skills/web-design-guidelines/
```
...
```text
skill_view(name="web-design-guidelines")
```
...
```text
Use the web design guidelines skill to <describe your specific task here>
```
...
```text
Gunakan skill web design guidelines untuk <deskripsikan tugas spesifik Anda di sini>
```
